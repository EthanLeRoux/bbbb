 ...
 * 
 * @param {Object} input - Priority calculation inputs
 * @returns {Object} PriorityScoreResult with detailed breakdown
 * 
 * Priority Formula:
 ...
 */
function calculateRecencyComponent(daysSinceLastReview) {
 ...
 */
function calculateLapseRate(attempts) {
 ...
 */
function getPriorityRecommendations(priorityScore) {
 ...
 */
function filterByPriority(entities, minPriority) {
 ...
 */
function validatePriorityScoreResult(result) {
  return (
