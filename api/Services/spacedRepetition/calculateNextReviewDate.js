 ...
 * @returns {Object} NextReviewDateResult with scheduling details
 * 
 ...
 */
function calculateNextReviewDate(input) {
 ...
 */
function getBaseInterval(quality) {
  const baseIntervals = {
    fail: 1,    // 1 day
    again: 2,   // 2 days
    hard: 3,    // 3 days
 ...
 * Calculate enhanced interval with modifiers
 */
function calculateEnhancedInterval(baseInterval, input) {
 ...
 */
function calculateStrengthModifier(strength) {
 ...
 */
function calculateReviewCountModifier(reviewCount) {
 ...
 */
function calculateIntervalModifier(currentInterval, baseInterval) {
 ...
 */
function calculateIntervalConfidence(input, quality) {
 ...
 */
function getSchedulingReason(quality, intervalDays, input) {
 ...
 */
function isReviewDue(nextReviewDate, currentDate = new Date()) {
 ...
 */
function getDaysUntilReview(nextReviewDate, currentDate = new Date()) {
 ...
 * Get review status
 */
function getReviewStatus(nextReviewDate, currentDate = new Date()) {
 ...
 */
function validateNextReviewDateResult(result) {
  return (
...
module.exports = {
  ...
  getScoreFromQuality,
  getBaseInterval,
  calculateEnhancedInterval,
  calculateStrengthModifier,
  calculateReviewCountModifier,
  calculateIntervalModifier,
  calculateIntervalConfidence,
  getSchedulingReason,
  getStrengthDescription,
  isReviewDue,
  getDaysUntilReview,
  getReviewStatus,
  validateNextReviewDateResult
};
